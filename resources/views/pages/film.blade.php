                ...
                <form action=""  method="POST" enctype="" id="filmadat">
                    @csrf
                        <div class="row" id="index">
                          ...
                          <div class="col-sm-9">
                            <input type="text"  class="form-control" id="filmid" name="filmid" value="">
                          </div>
                        </div>
                        <div class="row">
                            <label for="fcim" class="col-sm-3 col-form-label">Film címe</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control fcim" id="fcim" name="cim" placeholder="Mátrix feltámadások" required>
                          </div>
                        </div>
                        <div class="row">
            ...
            <div id="filmtarolo" class="row g-3 szulo">
                ...
                <div class="col-lg-4 col-sm-6 gyerek">
                    <div class="filmadatok">
                        ...
                        <div class="row">
                            <h2  class="col-sm-12">Link</h2>
                            <p class="col-sm-12 youtubeLink">posters/4507D2R-lg.jpg</p>
                        </div>
